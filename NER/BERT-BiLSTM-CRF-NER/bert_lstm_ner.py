...
if os.name == 'nt':
    bert_path = r'E:\Pycharm\demo\NER\Name-Entity-Recognition\BERT-BiLSTM-CRF-NER\checkpoint\chinese_L-12_H-768_A-12'
    root_path = r'E:\Pycharm\demo\NER\Name-Entity-Recognition\BERT-BiLSTM-CRF-NER'
else:
...
flags.DEFINE_string("data_dir", os.path.join(root_path, 'NERdata'), "The input datadir.",)
